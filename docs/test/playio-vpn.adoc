...
| 31/32/33
| `ARMv7`/`ARM64`/`x86_64`
| :warning: https://github.com/play-iot/iot-vpn/issues/10[SELinux]
...
| 8/10
| `x86_64`
| :warning: https://www.softether.org/[SoftetherVPN]
...
* +++<input type="checkbox" class="task-list-item-checkbox" disabled="disabled" checked="checked">++++++</input>+++`connman` https://github.com/play-iot/iot-vpn/issues/91[:warning: Manual step]

=== How to use

Please read xref:./cli/python/src/client/README.adoc[VPNC README]
